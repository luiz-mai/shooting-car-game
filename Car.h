...
vector<Rectangle> bodyRectangles;       //Contains all the rectangles of the car's body.
vector<Triangle> bodyTriangles;         //Contains all the triangles of the car's body.
...
//PARAMETER: (vector<Car>) vector containing all the cars that must be checked.
